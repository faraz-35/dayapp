...
-- the seed runs (SQLite date modifiers, each shifted −6 hours onto the app's
-- 6am→6am logical day), so the journal's week of history, the done-today row,
-- the greyed daily, and the pending reminder all demo correctly no matter when
-- the seed was planted or re-planted.
--
...
INSERT INTO meta (key, value) VALUES
  ('last_sweep_date', date('now','localtime','-6 hours'));

-- ---- Projects --------------------------------------------------------------
-- meridian = the product, growth = getting users, health = the operator.

INSERT INTO projects (id, name, sort_order, created_at) VALUES
  ('demo-p-meridian', 'meridian', 0, date('now','localtime','-6 hours','-30 days') || 'T09:00:00'),
  ('demo-p-growth',   'growth',   1, date('now','localtime','-6 hours','-30 days') || 'T09:00:00'),
  ('demo-p-health',   'health',   2, date('now','localtime','-6 hours','-20 days') || 'T09:00:00');
...
INSERT INTO goals (id, text, horizon, status, project_id, sort_order, created_at, updated_at, achieved_at) VALUES
  ('demo-g-timeless', 'Build software people genuinely love using',
   ...
   date('now','localtime','-6 hours','-30 days') || 'T21:30:00',
   date('now','localtime','-6 hours','-30 days') || 'T21:30:00', NULL),
  ('demo-g-long', 'Grow meridian into a profitable one-person business',
   'long', 'active', 'demo-p-meridian', 0,
   date('now','localtime','-6 hours','-30 days') || 'T21:35:00',
   date('now','localtime','-6 hours','-30 days') || 'T21:35:00', NULL),
  ('demo-g-beta', 'Ship the mobile beta to 100 users',
   'short', 'active', 'demo-p-meridian', 0,
   date('now','localtime','-6 hours','-6 days') || 'T08:40:00',
   date('now','localtime','-6 hours','-6 days') || 'T08:40:00', NULL),
  ('demo-g-waitlist', 'Launch the public waitlist page',
   'short', 'achieved', 'demo-p-growth', 1,
   date('now','localtime','-6 hours','-15 days') || 'T10:00:00',
   date('now','localtime','-6 hours','-8 days') || 'T16:20:00',
   date('now','localtime','-6 hours','-8 days') || 'T16:20:00');
...
INSERT INTO items (id, text, section, status, last_completed_date, sort_order, created_at, updated_at, hidden, hidden_until, project_id, remind_at, priority, assigned_to_agent, details) VALUES
  ('demo-t-pr', 'Review PR #214 — search ranking tweak',
   'today', 'active', NULL, 0,
   date('now','localtime','-6 hours','-2 days') || 'T11:12:00',
   date('now','localtime','-6 hours','-1 days') || 'T09:05:00', 0, NULL, 'demo-p-meridian', NULL, 2, 0, ''),
  ('demo-t-crash', 'Fix crash on first-launch onboarding',
   'today', 'done', date('now','localtime','-6 hours'), 1,
   date('now','localtime','-6 hours','-1 days') || 'T08:55:00',
   date('now','localtime','-6 hours') || 'T09:41:00', 0, NULL, 'demo-p-meridian', NULL, 1, 0, ''),
  ('demo-t-investor', 'Draft monthly investor update',
   'today', 'active', NULL, 2,
   date('now','localtime','-6 hours') || 'T08:15:00',
   date('now','localtime','-6 hours') || 'T08:15:00', 0, NULL, 'demo-p-growth', NULL, NULL, 0, ''),
  ('demo-t-interviews', 'Compile user interview insights',
   'today', 'active', NULL, 3,
   date('now','localtime','-6 hours','-2 days') || 'T16:45:00',
   date('now','localtime','-6 hours','-1 days') || 'T09:20:00', 0, NULL, 'demo-p-growth', NULL, NULL, 1,
  ...
  ('demo-t-gym', 'Gym — push day',
   'today', 'active', NULL, 4,
   date('now','localtime','-6 hours','-4 days') || 'T07:30:00',
   date('now','localtime','-6 hours','-1 days') || 'T09:25:00', 0, NULL, 'demo-p-health', NULL, NULL, 0, '');
...
INSERT INTO items (id, text, section, status, last_completed_date, sort_order, created_at, updated_at, hidden, hidden_until, project_id, remind_at, priority, assigned_to_agent, details) VALUES
  ('demo-d-deepwork', 'Morning deep work block',
   'daily', 'active', NULL, 0,
   date('now','localtime','-6 hours','-20 days') || 'T07:00:00',
   date('now','localtime','-6 hours','-20 days') || 'T07:00:00', 0, NULL, NULL, NULL, NULL, 0, ''),
  ('demo-d-read', 'Read 20 pages',
   'daily', 'active', NULL, 1,
   date('now','localtime','-6 hours','-18 days') || 'T21:00:00',
   date('now','localtime','-6 hours','-18 days') || 'T21:00:00', 0, NULL, NULL, NULL, NULL, 0, ''),
  ('demo-d-walk', 'Walk 8k steps',
   'daily', 'active', date('now','localtime','-6 hours'), 2,
   date('now','localtime','-6 hours','-12 days') || 'T08:00:00',
   date('now','localtime','-6 hours') || 'T07:12:00', 0, NULL, 'demo-p-health', NULL, NULL, 0, '');
...
INSERT INTO items (id, text, section, status, last_completed_date, sort_order, created_at, updated_at, hidden, hidden_until, project_id, remind_at, priority, assigned_to_agent, details) VALUES
  ('demo-b-ssl', 'Renew meridian SSL certificate',
   ...
   date('now','localtime','-6 hours','-6 days') || 'T10:00:00',
   date('now','localtime','-6 hours','-6 days') || 'T10:00:00', 0, NULL, 'demo-p-meridian', NULL, 1, 0, ''),
  ('demo-b-roadmap', 'Draft next quarter''s product roadmap',
   'backlog', 'active', NULL, 1,
   date('now','localtime','-6 hours','-5 days') || 'T15:30:00',
   date('now','localtime','-6 hours','-1 days') || 'T11:40:00', 0, NULL, 'demo-p-meridian', NULL, 1, 0, ''),
  ('demo-b-funnel', 'Audit onboarding funnel drop-off',
   'backlog', 'active', NULL, 2,
   date('now','localtime','-6 hours','-4 days') || 'T09:10:00',
   date('now','localtime','-6 hours','-2 days') || 'T00:01:00', 0, NULL, 'demo-p-growth', NULL, 2, 0, ''),
  ('demo-b-analytics', 'Self-host the analytics stack',
   'backlog', 'active', NULL, 3,
   date('now','localtime','-6 hours','-3 days') || 'T13:20:00',
   date('now','localtime','-6 hours','-3 days') || 'T13:20:00', 0, NULL, NULL, NULL, 2, 0, ''),
  ('demo-b-shapeup', 'Re-read Shape Up',
   'backlog', 'active', NULL, 4,
   date('now','localtime','-6 hours','-4 days') || 'T19:45:00',
   date('now','localtime','-6 hours','-4 days') || 'T19:45:00', 0, NULL, NULL, NULL, NULL, 0, ''),
  ('demo-b-trip', 'Plan anniversary trip',
   'backlog', 'active', NULL, 5,
   date('now','localtime','-6 hours','-9 days') || 'T20:10:00',
   date('now','localtime','-6 hours','-1 days') || 'T00:01:00', 0, NULL, NULL, NULL, NULL, 0, ''),
  ('demo-b-dentist', 'Book dentist appointment',
   'backlog', 'active', NULL, 6,
   date('now','localtime','-6 hours','-2 days') || 'T12:00:00',
   date('now','localtime','-6 hours','-2 days') || 'T12:00:00', 0, NULL, NULL, date('now','localtime','-6 hours','+3 days'), NULL, 0, ''),
  ('demo-b-pricing', 'Research competitor pricing pages',
   'backlog', 'active', NULL, 7,
   date('now','localtime','-6 hours','-2 days') || 'T16:30:00',
   date('now','localtime','-6 hours','-2 days') || 'T16:30:00', 0, NULL, 'demo-p-growth', NULL, NULL, 1,
  ...
  ('demo-b-copy', 'Old landing page copy drafts',
   ...
   date('now','localtime','-6 hours','-25 days') || 'T14:00:00',
   date('now','localtime','-6 hours','-10 days') || 'T18:00:00', 1, NULL, 'demo-p-growth', NULL, NULL, 0, '');
...
- A/B a plain-text email against the designed template',
   0,
   date('now','localtime','-6 hours','-3 days') || 'T10:22:00',
   date('now','localtime','-6 hours','-3 days') || 'T10:31:00', 0, NULL, 1, 'demo-p-growth'),
  ('demo-n-standup',
   'Standup notes
...
- record the screencast for this week''s changelog',
   1,
   date('now','localtime','-6 hours','-1 days') || 'T09:50:00',
   date('now','localtime','-6 hours','-1 days') || 'T09:58:00', 0, NULL, 2, 'demo-p-meridian'),
  ('demo-n-gifts',
   'Gift ideas for dad — fishing rod, nice whiskey, that cheese board',
   2,
   date('now','localtime','-6 hours','-12 days') || 'T18:40:00',
   date('now','localtime','-6 hours','-12 days') || 'T18:40:00', 1, NULL, NULL, NULL);
...
INSERT INTO sessions (id, item_id, item_text, started_at, ended_at, duration_secs) VALUES
  ('demo-s-t1', 'demo-d-deepwork', 'Morning deep work block',
   date('now','localtime','-6 hours') || 'T09:00:00', date('now','localtime','-6 hours') || 'T10:25:00', 5100),
  ('demo-s-t2', 'demo-t-crash', 'Fix crash on first-launch onboarding',
   date('now','localtime','-6 hours') || 'T10:32:00', date('now','localtime','-6 hours') || 'T11:14:00', 2520),
  ('demo-s-y1', 'demo-d-deepwork', 'Morning deep work block',
   date('now','localtime','-6 hours','-1 days') || 'T09:30:00', date('now','localtime','-6 hours','-1 days') || 'T11:15:00', 6300),
  ('demo-s-y2', 'demo-t-pr', 'Review PR #214 — search ranking tweak',
   date('now','localtime','-6 hours','-1 days') || 'T13:55:00', date('now','localtime','-6 hours','-1 days') || 'T15:10:00', 4500),
  ('demo-s-d2a', 'demo-d-deepwork', 'Morning deep work block',
   date('now','localtime','-6 hours','-2 days') || 'T09:00:00', date('now','localtime','-6 hours','-2 days') || 'T10:40:00', 6000),
  ('demo-s-d3a', 'demo-x-blog', 'Write the launch blog post',
   date('now','localtime','-6 hours','-3 days') || 'T10:05:00', date('now','localtime','-6 hours','-3 days') || 'T12:00:00', 6900),
  ('demo-s-d5a', 'demo-d-deepwork', 'Morning deep work block',
   date('now','localtime','-6 hours','-5 days') || 'T09:05:00', date('now','localtime','-6 hours','-5 days') || 'T10:35:00', 5400);
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ...
  ('demo-x-ci', NULL, 'Set up CI cache for faster builds', 'created', NULL, 'backlog', NULL, 'active',
   date('now','localtime','-6 hours','-7 days') || 'T10:15:00'),
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ('demo-x-blog', NULL, 'Write the launch blog post', 'created', NULL, 'backlog', NULL, 'active',
   date('now','localtime','-6 hours','-5 days') || 'T09:20:00'),
  ('demo-d-deepwork', NULL, 'Morning deep work block', 'completed', 'daily', 'daily', 'active', 'active',
   date('now','localtime','-6 hours','-5 days') || 'T10:35:00'),
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ...
  ('demo-t-gym', NULL, 'Gym — push day', 'created', NULL, 'backlog', NULL, 'active',
   date('now','localtime','-6 hours','-4 days') || 'T09:30:00'),
  ('demo-x-news', NULL, 'Send newsletter issue #12', 'completed', 'today', 'today', 'active', 'done',
   date('now','localtime','-6 hours','-4 days') || 'T15:00:00'),
  ('demo-x-news', NULL, 'Send newsletter issue #12', 'uncompleted', 'today', 'today', 'done', 'active',
   date('now','localtime','-6 hours','-4 days') || 'T15:40:00'),
  ('demo-x-news', NULL, 'Send newsletter issue #12', 'completed', 'today', 'today', 'active', 'done',
   date('now','localtime','-6 hours','-4 days') || 'T16:10:00'),
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ('demo-x-blog', NULL, 'Write the launch blog post', 'moved', 'backlog', 'today', NULL, NULL,
   date('now','localtime','-6 hours','-3 days') || 'T08:30:00'),
  ('demo-b-funnel', NULL, 'Audit onboarding funnel drop-off', 'moved', 'backlog', 'today', NULL, NULL,
   date('now','localtime','-6 hours','-3 days') || 'T08:50:00'),
  ...
  ('demo-x-blog', NULL, 'Write the launch blog post', 'completed', 'today', 'today', 'active', 'done',
   date('now','localtime','-6 hours','-3 days') || 'T14:30:00');
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ('demo-b-funnel', NULL, 'Audit onboarding funnel drop-off', 'fell_to_backlog', 'today', 'backlog', NULL, NULL,
   date('now','localtime','-6 hours','-2 days') || 'T00:01:00'),
  ('demo-t-pr', NULL, 'Review PR #214 — search ranking tweak', 'created', NULL, 'backlog', NULL, 'active',
   date('now','localtime','-6 hours','-2 days') || 'T11:12:00'),
  ('demo-d-deepwork', NULL, 'Morning deep work block', 'completed', 'daily', 'daily', 'active', 'active',
   date('now','localtime','-6 hours','-2 days') || 'T11:15:00'),
  ...
  ('demo-b-trip', NULL, 'Plan anniversary trip', 'moved', 'backlog', 'today', NULL, NULL,
   date('now','localtime','-6 hours','-2 days') || 'T19:00:00'),
  ('demo-d-read', NULL, 'Read 20 pages', 'completed', 'daily', 'daily', 'active', 'active',
   date('now','localtime','-6 hours','-2 days') || 'T22:05:00');
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ('demo-b-trip', NULL, 'Plan anniversary trip', 'fell_to_backlog', 'today', 'backlog', NULL, NULL,
   date('now','localtime','-6 hours','-1 days') || 'T00:01:00'),
...
INSERT INTO actions (item_id, goal_id, item_text, action, from_section, to_section, from_status, to_status, timestamp) VALUES
  ...
  ('demo-t-crash', NULL, 'Fix crash on first-launch onboarding', 'completed', 'today', 'today', 'active', 'done',
   date('now','localtime','-6 hours') || 'T09:41:00');
